...
const cakes = [
  {
    id: 1,
    name: 'Cupcakes',
    basic: 'Basic cupcakes',
    basicprice: '35/dozen',
    decorated: 'Decorated cupcakes',
    decoratedprice: '40/dozen',
    image: new URL('@/assets/articles/cupcakes.jpeg', import.meta.url).href,
  },
  {
    id: 2,
    name: 'Sugar cookies',
